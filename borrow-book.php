<?php
            ...
            if(isset($_POST['button'])){
                ...
                $null = 0;
                $sql = "SELECT * FROM books WHERE Title='$null'";
                $query = mysqli_query($con, $sql);
            } else {
                $null = 0;
                $sql = "SELECT * FROM books WHERE Title='$null'";
...
<head>
    ...
    <link rel="stylesheet" href="css/borrow-book.css">
    ...
    <div class="content">
        ...
        <div class="search">
            ...
            <form action="" method="POST">
                ...
                <button class="button see" name="clear">CLEAR</button>
            </form>
        </div>
        ...
        <div class="search-result">
            <table cellspacing="0">
                ...
                <form action="book-info.php" method="POST">
                    <tr>
                        <?php
                        ...
                        ?>
                            ...
                            <td><button name="submit" type="submit" class="borrow-button">BORROW</button></td>
                    </tr>
                    <?php
                        }
                    ?>
